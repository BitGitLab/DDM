...
public class ConstraintsSolving
{
	...
	{		
        ...
        if (OS.indexOf("mac") >= 0) {
        	...
        	if(new File("/Users/ningge/codes/java/FMCR/z3-4.7.1-x64-osx-10.11.6/bin/z3").exists()){

				Z3_PATH = "/Users/ningge/codes/java/FMCR/z3-4.7.1-x64-osx-10.11.6/bin/z3";
			}

		} else if (OS.indexOf("windows") >= 0) {
			Z3_PATH = "D:\\MCR\\JMCR\\z3-windows\\z3-4.6.0-x64-win\\bin\\z3.exe";
		}
		else {
...
//		        	model.print();
	...
	public Vector<String> computeSchedule(Model model) {
		...
		ArrayList<String> keylist = new ArrayList(sortedMap.keySet());
