...
public class Manager {
    ...
    public static void main(String[] arg) {
        ...
        released_counter = 0;
        flag = false;
        req_counter_lock = new String();
        rel_counter_lock = new String();
        notes_lock = new String();
        num_of_notes_set = 0;

        arg = new String[3];
        arg[0] = "./src/test/examples/manager/output.txt";
        arg[1] = "3";
        arg[2] = "3";
...
//        }
        ...
        flag = !(init_req_counter == released_counter);
        assert !flag : ("ERROR: records don't match !!!");
//        if (flag) {
