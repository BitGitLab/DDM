 ...
 */
    ...
    public void checkResult(String str1, String str2)
    {
        ...
        //System.out.println("sold:" + Num_Of_Seats_Sold + ", capacity:" + Maximum_Capacity);
        assert Num_Of_Seats_Sold <= Maximum_Capacity : (str2);
 ...
 */
    ...
    public static void main(String args[]) {
        ...
        if (args.length != 2) {
            //throw new Exception();
        	  args = new String[2];
        	  args[0] = "./src/test/examples/airlinetickets/output.txt";
        	  args[1] = "little";
          }
