...

     ...
     * using the <code>{@link #File(File, String)
     ...
     * pathnames are accepted.  Otherwise, a pathname satisfies the filter
     * if and only if the value <code>true</code> results when the
     * <code>{@link FileFilter#accept(File)}</code> method of
...

     ...
     * SecurityManager#checkRead(String)}</code> method
...
    
     ...
     * is equivalent to invoking <code>{@link #(String,
     * String, java.io.File)
